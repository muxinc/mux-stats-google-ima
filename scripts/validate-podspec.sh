...
pod lib lint --skip-tests --allow-warnings --use-libraries

echo "--- Linting Podspec (using libraries and modular headers)"
pod lib lint --skip-tests --allow-warnings --use-libraries --use-modular-headers

echo "--- Linting Podspec (using static frameworks)"
pod lib lint --skip-tests --allow-warnings --use-static-frameworks
